class Translation:
    ...
    def get_translation(self, lang: str, firstKey: str, secondKey: str, thirdKey: str, **kwargs):
        """
        Retrieve the translation for the specified language and keys, formatting it with any additional parameters.

        :param lang: The language code, e.g., 'en' or 'ru'.
        :param firstKey: The first key in the translation dictionary, e.g., 'handlers'.
        :param secondKey: The second key in the translation dictionary, e.g., 'forecast'.
        :param thirdKey: The third key in the translation dictionary, e.g., 'get_location'.
        :param kwargs: Additional arguments to format the string.
        :return: Formatted translation string.
        """
        try:
            template = self.translations[lang][firstKey][secondKey][thirdKey]
            return template.format(**kwargs)
        except KeyError:
            return "Translation not found. Please contact the administrator" 